...
export async function POST(req: NextRequest) {
	...
	await prisma.employeeDocument.create({ data: { user_id: session.userId, file_name: saved.filename, file_path: saved.filepath, file_type: file_type as "CV" | "DIPLOMA" | "CERTIFICATE" } });
